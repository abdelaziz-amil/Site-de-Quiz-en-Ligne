...
class Compte extends CI_Controller {
    ...
    public function creer()
    {
        ...
        $this->form_validation->set_rules('mail', 'mail', 'required|valid_email',array('required'=>
        'Veuillez saisir un E-mail !','valid_email' => 'Veuillez saisir un E-mail Valide !'));
    ...
    public function desactiver_match($code){
        $id = $this->db_model->get_mat_id($code);
        $this->db_model->get_score_match($id->id);
